...
import android.support.p007v4.graphics.TypefaceCompat;
import android.support.p007v4.graphics.TypefaceCompatUtil;
import android.support.p007v4.provider.SelfDestructiveThread;
...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public final int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p007v4.provider.FontsContractCompat.C01445.compare(byte[], byte[]):int");
        }
    };
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:38:0x008c, code lost:
        sBackgroundThread.postAndReply(r1, new android.support.p007v4.provider.FontsContractCompat.C01333());
     */
    /* JADX WARNING: Code restructure failed: missing block: B:39:0x0096, code lost:
        return null;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static android.graphics.Typeface getFontSync(final android.content.Context r2, final android.support.p007v4.provider.FontRequest r3, final android.support.p007v4.content.res.ResourcesCompat.FontCallback r4, final android.os.Handler r5, boolean r6, int r7, final int r8) {
        /*
        ...
        L_0x0045:
            ...
            android.support.v4.provider.FontsContractCompat$TypefaceResult r3 = (android.support.p007v4.provider.FontsContractCompat.TypefaceResult) r3     // Catch:{ InterruptedException -> 0x0058 }
        ...
        L_0x0097:
            ...
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p007v4.provider.FontsContractCompat.getFontSync(android.content.Context, android.support.v4.provider.FontRequest, android.support.v4.content.res.ResourcesCompat$FontCallback, android.os.Handler, boolean, int, int):android.graphics.Typeface");
    }
