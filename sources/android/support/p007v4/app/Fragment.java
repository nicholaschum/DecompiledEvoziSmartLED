...
import android.arch.lifecycle.C0034t;
...
public class Fragment implements C0015ab, C0024j, ComponentCallbacks, View.OnCreateContextMenuListener {
    ...
    C0025k mLifecycleRegistry = new C0025k(this);
    ...
    View mView;
    C0024j mViewLifecycleOwner;
    C0034t<C0024j> mViewLifecycleOwnerLiveData = new C0034t<>();
    C0025k mViewLifecycleRegistry;
    C0014aa mViewModelStore;
    String mWho;
    ...
    public C0024j getViewLifecycleOwner() {
    ...
    public LiveData<C0024j> getViewLifecycleOwnerLiveData() {
        return this.mViewLifecycleOwnerLiveData;
    }

    public C0014aa getViewModelStore() {
        if (getContext() != null) {
            if (this.mViewModelStore == null) {
                this.mViewModelStore = new C0014aa();
            }
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (this.mCalled) {
            this.mLifecycleRegistry.mo69a(C0021g.ON_CREATE);
            return;
        }
    ...
    public void performCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        this.mViewLifecycleOwner = new C0024j() {
            public C0020f getLifecycle() {
                if (Fragment.this.mViewLifecycleRegistry == null) {
                    Fragment.this.mViewLifecycleRegistry = new C0025k(Fragment.this.mViewLifecycleOwner);
                }
    ...
    public void performDestroy() {
        this.mLifecycleRegistry.mo69a(C0021g.ON_DESTROY);
        if (this.mChildFragmentManager != null) {
    ...
    public void performDestroyView() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.mo69a(C0021g.ON_DESTROY);
        }
        if (this.mChildFragmentManager != null) {
    ...
    public void performPause() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.mo69a(C0021g.ON_PAUSE);
        }
        this.mLifecycleRegistry.mo69a(C0021g.ON_PAUSE);
        if (this.mChildFragmentManager != null) {
    ...
    public void performResume() {
        ...
        if (this.mCalled) {
            ...
            this.mLifecycleRegistry.mo69a(C0021g.ON_RESUME);
            if (this.mView != null) {
                this.mViewLifecycleRegistry.mo69a(C0021g.ON_RESUME);
                return;
            }
            return;
        }
    ...
    public void performStart() {
        ...
        if (this.mCalled) {
            ...
            this.mLifecycleRegistry.mo69a(C0021g.ON_START);
            if (this.mView != null) {
                this.mViewLifecycleRegistry.mo69a(C0021g.ON_START);
                return;
            }
            return;
        }
    ...
    public void performStop() {
        if (this.mView != null) {
            this.mViewLifecycleRegistry.mo69a(C0021g.ON_STOP);
        }
        this.mLifecycleRegistry.mo69a(C0021g.ON_STOP);
        if (this.mChildFragmentManager != null) {
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            ...
            this.mViewLifecycleRegistry.mo69a(C0021g.ON_CREATE);
        }
    }
