...
public class FragmentActivity extends SupportActivity implements C0015ab, ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private C0014aa mViewModelStore;
    ...
    private void markFragmentsCreated() {
        do {
        } while (markState(getSupportFragmentManager(), C0022h.CREATED));
    }

    private static boolean markState(FragmentManager fragmentManager, C0022h hVar) {
        boolean z = false;
        for (Fragment next : fragmentManager.getFragments()) {
            if (next != null) {
                if (next.getLifecycle().mo64a().mo67a(C0022h.STARTED)) {
                    next.mLifecycleRegistry.mo70a(hVar);
                    z = true;
                }
                FragmentManager peekChildFragmentManager = next.peekChildFragmentManager();
                if (peekChildFragmentManager != null) {
                    z |= markState(peekChildFragmentManager, hVar);
                }
            }
        }
        return z;
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        if (i2 != 0) {
            int i3 = i2 - 1;
            String str2 = this.mPendingFragmentActivityResults.get(i3);
            ...
            if (str2 == null) {
                ...
                if (findFragmentByWho == null) {
                    str = TAG;
                    concat = "Activity result no fragment exists for who: ".concat(String.valueOf(str2));
                } else {
