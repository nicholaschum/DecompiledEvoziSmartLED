...
public final class NotificationManagerCompat {
    ...
    class CancelTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            if (this.all) {
                ...
                iNotificationSideChannel.cancel(this.packageName, this.f268id, this.tag);
            }
        }

        public String toString() {
            return "CancelTask[" + "packageName:" + this.packageName + ", id:" + this.f268id + ", tag:" + this.tag + ", all:" + this.all + "]";
        }
    }
    ...
    class NotifyTask implements Task {
        ...
        public void send(INotificationSideChannel iNotificationSideChannel) {
            iNotificationSideChannel.notify(this.packageName, this.f269id, this.tag, this.notif);
        }

        public String toString() {
            return "NotifyTask[" + "packageName:" + this.packageName + ", id:" + this.f269id + ", tag:" + this.tag + "]";
        }
    }
