...
import android.support.p007v4.view.NestedScrollingChild2;
...
public class NestedScrollView extends FrameLayout implements NestedScrollingChild2, NestedScrollingParent2, ScrollingView {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:13:0x0068, code lost:
        android.support.p007v4.view.ViewCompat.postInvalidateOnAnimation(r23);
     */
    ...
    public boolean onTouchEvent(android.view.MotionEvent r24) {
        ...
        L_0x0167:
            ...
            float r3 = (float) r3
            float r2 = r2 / r3
            android.support.p007v4.widget.EdgeEffectCompat.onPull(r0, r1, r2)
        ...
        L_0x0196:
            ...
            float r2 = r2 / r4
            float r3 = r3 - r2
            android.support.p007v4.widget.EdgeEffectCompat.onPull(r0, r1, r3)
            android.widget.EdgeEffect r0 = r10.mEdgeGlowTop
            boolean r0 = r0.isFinished()
            if (r0 != 0) goto L_0x01c0
            android.widget.EdgeEffect r0 = r10.mEdgeGlowTop
    ...
    public boolean overScrollByCompat(int r13, int r14, int r15, int r16, int r17, int r18, int r19, int r20, boolean r21) {
        ...
        L_0x0087:
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p007v4.widget.NestedScrollView.overScrollByCompat(int, int, int, int, int, int, int, int, boolean):boolean");
    }
