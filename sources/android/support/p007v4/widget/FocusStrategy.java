...
class FocusStrategy {
    ...
    public static <L, T> T findNextFocusInAbsoluteDirection(L r7, android.support.p007v4.widget.FocusStrategy.CollectionAdapter<L, T> r8, android.support.p007v4.widget.FocusStrategy.BoundsAdapter<T> r9, T r10, android.graphics.Rect r11, int r12) {
        /*
